const big1234 = '1234'.repeat(1000);
const bigBtoa = 'F)}kW'.repeat(1000);
...
export const data = [
  ...
  },
  {
    ...
    enc: {
      btoa:
        'O<`^zX>%ZCX>)XGZfA9Ab7*B`EFf-gbRchTY<VDJc_3(Mb0BhMVRLV8EFfZabRc4RA' +
  ...
  {
    raw: Buffer.from([
      0x8e, 0x0b, 0xdd, 0x69, 0x76, 0x28, 0xb9, 0x1d, 0x8f, 0x24, 0x55, 0x87,
      0xee, 0x95, 0xc5, 0xb0, 0x4d, 0x48, 0x96, 0x3f, 0x79, 0x25, 0x98, 0x77,
