...
describe('ipv6', () => {
  ...
  it.each([
    ...
    [Buffer.from([0x10, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x08, 0x00, 0x20, 0x0C, 0x41, 0x7A]), '4)+k&C#VzJ4br>0wv%Yp'],
    [Buffer.from([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]), '=r54lj&NUUO~Hi%c2ym0'],
  ])('encode #%# ', (raw, encoded) => {
